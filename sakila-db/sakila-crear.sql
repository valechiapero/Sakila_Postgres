...
CREATE TABLE sakila.address (
    ...
    location POINT, -- Assuming you have a POINT datatype available, otherwise, use VARCHAR
    last_update TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE sakila.film (
    ...
    special_features VARCHAR(255)[] DEFAULT '{}', -- Use array type instead of TEXT array
    last_update TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
